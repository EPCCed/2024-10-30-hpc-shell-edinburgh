...
``r config$remote$homedir`yourUsername`, which is your user's **home
...
```bash
$ cd `r config$remote$homedir`yourUserName
$ cd ~
$ cd
```
...
```
```output
`r config$remote$homedir`yourUserName/documents
`r config$remote$homedir`yourUserName
```
